<?php
    ...
    $img = strtoupper(htmlspecialchars($_POST['img'],ENT_QUOTES,'UTF-8'));

    $ruta='controller/tramite/documentos/'.$nombrearchivo;
    $consulta = $MU->Registrar_Tramite($dni,$nom,$apt,$apm,$cel,$ema,$dir,$vpresentacion,$ruc,$raz,$arp,$ard,$tip,$ndo,$asu,$ruta,$fol,$idusu,$img);
    //D00000001
    if($consulta){
        if($nombrearchivo !=""){
