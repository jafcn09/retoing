...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="index.php" class="nav-link"><i class="fa fa-user"></i> Iniciar Sesion</a>
          </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Version 4.0.0 <a href="https://jafcn09.github.io/blog/">Jhafet Canepa</a>.</strong> Todo los derechos reservados 
  </footer>
</div>
<!-- ./wrapper -->
